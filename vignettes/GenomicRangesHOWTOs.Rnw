...
\date{Edited: January 2018; Compiled: \today}
...
See \Rcode{?makeTxDbFromUCSC} in the \Biocpkg{GenomicFeatures}
...
See \Rcode{?makeTxDbFromBiomart} in the \Biocpkg{GenomicFeatures}
package for more information.
...
See \Rcode{?makeTxDbFromGFF} in the \Biocpkg{GenomicFeatures}
package for more information.
...
library(KEGGgraph)
dest <- tempfile()
retrieveKGML(tag, "hsa", dest, method="wget")
@
