...
%\VignetteDepends{AnnotationHub, BSgenome.Hsapiens.UCSC.hg38, BSgenome.Scerevisiae.UCSC.sacCer2, cigarillo, DESeq2, edgeR, GenomicAlignments, GenomicFeatures, KEGGgraph, KEGGREST, pasillaBamSubset, Rsamtools, SummarizedExperiment, TxDb.Athaliana.BioMart.plantsmart51, TxDb.Dmelanogaster.UCSC.dm3.ensGene, TxDb.Hsapiens.UCSC.hg38.knownGene, txdbmaker}
...
\date{Edited: September 2026; Compiled: \today}
...
<<TxDb.Athaliana.BioMart.plantsmart51_1>>=
...
<<TxDb.Athaliana.BioMart.plantsmart51_2>>=
exons(txdb)
@
...
Use the \Rfunction{project\_sequences} function from the \Biocpkg{cigarillo}
package to {\it project} the query sequences and quality strings onto the
{\it reference space}.
