...
\Biocpkg{DESeq} and \Biocpkg{edgeR}. 
...
See \Rcode{?'BamViews-class' or ?'BamFile-class'} in \Biocpkg{Rsamtools}.
...
in differential expression methods offered in the \Biocpkg{DESeq} 
package. 
