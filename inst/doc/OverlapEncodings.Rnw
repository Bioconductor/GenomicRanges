...
76.54\% of the reads are ``compatible'' with at least 1 transcript in
\Rcode{dm3tx}.
...
70.13\% of the reads are ``compatible'' with at least 1 transcript in
\Rcode{dm3tx}.
...
Only 0.73\% of the transcripts in \Rcode{dm3tx} are ``compatible'' with at
least 50 reads.
...
77.8\% of the reads are ``string-based compatible'' with at least 1
