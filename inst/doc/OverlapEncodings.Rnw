...
\Rcode{U3galp\_first\_oqseq} and \Rcode{reverseComplement(U3galp\_last\_oqseq)}:
...
Yes, the first 500 sequences in \Rcode{U3galp\_first\_oqseq} and
\Rcode{reverseComplement(U3galp\_last\_oqseq)} are ``close'' to the first 500
sequences in \Rcode{U3galp\_first\_rqseq} and \Rcode{U3galp\_last\_rqseq},
respectively.
