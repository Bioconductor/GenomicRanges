...
\begin{verbatim}
  - read (no gap):             oooooo
  - transcript:    5' ...  oooooooooooo  ... 3'
\end{verbatim}

  \item \Rcode{"2:jm:af:"}
\begin{verbatim}
  - read (1 gap):                oooo------oo
  - transcript:    5' ...  oooooooooo      ooooooo  ... 3'
\end{verbatim}

  \item \Rcode{"3:jmm:agm:aaf:"}
\begin{verbatim}
  - read (2 gaps):             ooo-----oo---------oooo
  - transcript:    5' ...  ooooooo     oo         oooooooooo  ... 3'
\end{verbatim}
\end{itemize}
...
\begin{verbatim}
  ...
  - transcript:    5' ...  ooooooo    oooo    oooooooo  ... 3'
\end{verbatim}

  \item \Rcode{"2:jm:am:am:af:"}
\begin{verbatim}
  - read (1 gap):            ooooo------------------ooo
  - transcript:    5' ...  ooooooo   ooooo   oooo   oooooooo  ... 3'
\end{verbatim}

  \item \Rcode{"3:jmm:agm:aam:aaf:"}
\begin{verbatim}
  - read (2 gaps):           ooooo----oooo-----------ooo
  - transcript:    5' ...  ooooooo    oooo   ooooo   oooooooo  ... 3'
\end{verbatim}
\end{itemize}
...
transcript \Rcode{"10"}, is that the 4 reported hits that skip exons 9 and 10
...
\begin{verbatim}
  - paired-end read (no gap on the left end, no gap on the
    right end):              ooo   oooo
  - transcript:  5' ...  oooooooooooooooo  ... 3'
\end{verbatim}
...
\begin{verbatim}
  ...
  - transcript:  5' ...  ooooooooo       ooooooooooooooo  ... 3'
\end{verbatim}
...
\begin{verbatim}
  ...
  - transcript:  5' ...  ooooooooooooooo       ooooooooo  ... 3'
\end{verbatim}
