...
Only 0.87\% of the transcripts in \Rcode{dm3tx} have an overlap with
at least 50 reads.
...
Only 0.86\% of the transcripts in \Rcode{dm3tx} are ``compatible''
...
Only 0.86\% of the transcripts in \Rcode{dm3tx} are ``string-based
